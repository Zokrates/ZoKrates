...
use ir::{Prog, Witness};
use proof_system::schemes::pghr13::PGHR13;
...
impl Backend<Bn128Field, PGHR13> for Libsnark {
    fn setup(
        ...
        <PGHR13 as Scheme<Bn128Field>>::ProvingKey,
        <PGHR13 as Scheme<Bn128Field>>::VerificationKey,
    ) {
    ...
    fn generate_proof(
        ...
        proving_key: <PGHR13 as Scheme<Bn128Field>>::ProvingKey,
