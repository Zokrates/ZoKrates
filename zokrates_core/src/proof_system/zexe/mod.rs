...
mod parse {
            ...
            "bw6_761" => {
                ...
                G1Affine(
                    ("0x".to_string() + captures.name(&"x").unwrap().as_str())
                        .to_string()
                        .to_lowercase(),
                    ("0x".to_string() + captures.name(&"y").unwrap().as_str())
                        .to_string()
                        .to_lowercase(),
                )
            }
    ...
    pub fn parse_g2<T: Field + ZexeFieldExtensions>(
        ...
        G2Affine(
            G1Affine(
                ("0x".to_string() + captures.name(&"x1").unwrap().as_str())
                    .to_string()
                    .to_lowercase(),
                ("0x".to_string() + captures.name(&"x0").unwrap().as_str())
                    .to_string()
                    .to_lowercase(),
            ),
            G1Affine(
                ("0x".to_string() + captures.name(&"y1").unwrap().as_str())
                    .to_string()
                    .to_lowercase(),
                ("0x".to_string() + captures.name(&"y0").unwrap().as_str())
                    .to_string()
                    .to_lowercase(),
            ),
        )
