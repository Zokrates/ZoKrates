...
use crate::ir::{IntoStatements, Ir, LinComb, ProgIterator, QuadComb, Statement, Witness};
...
impl Interpreter {
    pub fn execute<T: Field, I: IntoStatements<Ir<T>>>(
        &self,
    ...
    fn check_inputs<T, I: IntoStatements<Ir<T>>, U>(
        &self,
        program: &ProgIterator<T, I>,
        inputs: &[U],
    ) -> Result<(), Error> {
