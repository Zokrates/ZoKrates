...
pub trait ResultFolder<'ast, T: Field>: Sized {
    ...
    >(
        ...
        fold_if_else_expression(self, e)
    }
...
pub fn fold_field_expression<'ast, T: Field, F: ResultFolder<'ast, T>>(
    ...
    Ok(match e {
        ...
        FieldElementExpression::Select(e) => {
            let e = f.fold_select_expression(e)?;
            match e {
                SelectOrExpression::Expression(e) => e,
                SelectOrExpression::Select(e) => FieldElementExpression::Select(e),
            }
        }
        ...
        FieldElementExpression::IfElse(e) => {
            let e = f.fold_if_else_expression(e)?;
            match e {
                IfElseOrExpression::Expression(e) => e,
                IfElseOrExpression::IfElse(e) => FieldElementExpression::IfElse(e),
            }
        }
    })
}
...
pub fn fold_boolean_expression<'ast, T: Field, F: ResultFolder<'ast, T>>(
    ...
    Ok(match e {
        ...
        BooleanExpression::Select(e) => {
            let e = f.fold_select_expression(e)?;
            match e {
                SelectOrExpression::Expression(e) => e,
                SelectOrExpression::Select(e) => BooleanExpression::Select(e),
            }
        }
        ...
        BooleanExpression::IfElse(e) => {
            let e = f.fold_if_else_expression(e)?;
            match e {
                IfElseOrExpression::Expression(e) => e,
                IfElseOrExpression::IfElse(e) => BooleanExpression::IfElse(e),
            }
        }
    })
}
...
pub fn fold_uint_expression_inner<'ast, T: Field, F: ResultFolder<'ast, T>>(
    ...
    Ok(match e {
        ...
        UExpressionInner::Select(e) => {
            let e = f.fold_select_expression(e)?;
            match e {
                SelectOrExpression::Expression(e) => e,
                SelectOrExpression::Select(e) => UExpressionInner::Select(e),
            }
        }
        ...
        UExpressionInner::IfElse(e) => {
            ...
            match e {
                IfElseOrExpression::Expression(e) => e,
                IfElseOrExpression::IfElse(e) => UExpressionInner::IfElse(e),
            }
        }
    })
}
...
pub fn fold_select_expression<
    'ast,
    T: Field,
    E: Expr<'ast, T> + Select<'ast, T> + ResultFold<'ast, T>,
    F: ResultFolder<'ast, T>,
>(
    f: &mut F,
    e: SelectExpression<'ast, T, E>,
