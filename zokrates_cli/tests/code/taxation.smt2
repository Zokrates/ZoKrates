...
; Number of circuit variables: 258
; Number of equalities: 257
...
(= (mod (* (* |_2| 1) (+ (* |_0| 21888242871839275222246405745257275088548364400416034343698204186575808495616) (* |_1| 1))) |~prime|) (mod (* |_259| 1) |~prime|))
(= (mod (* (* |~one| 1) (* |_259| 1)) |~prime|) (mod (* |~out_0| 1) |~prime|))
))